...
const STATUS_CONFIG: Record<RefundStatus, {
  ...
  initiated: {
    ...
    icon: Clock, timeline: 'Expected in 5–7 business days',
  },
  processing: {
    label: 'Refund Processing',
    color: '#3B82F6', bgColor: '#EFF6FF',
    icon: RefreshCw, timeline: 'Expected in 3–5 business days',
  },
  completed: {
    label: 'Refund Completed',
    color: '#16A34A', bgColor: '#DCFCE7',
    icon: CheckCircle, timeline: 'Credited to your original payment method',
  },
  failed: {
    label: 'Refund Failed',
    color: '#EF4444', bgColor: '#FEE2E2',
    icon: AlertCircle, timeline: 'Contact support for assistance',
  },
};
...
const styles = StyleSheet.create({
  ...
  statusTimeline: { fontSize: 14, color: '#666', textAlign: 'center' },

  amountCard: {
    backgroundColor: '#FFF', borderRadius: 24, padding: 20, alignItems: 'center', gap: 6,
  ...
  stepCircleActive: { backgroundColor: '#FFF', borderColor: Colors.primary },
  stepNum: { fontSize: 13, fontWeight: '700', color: '#9CA3AF' },
  stepVline: { flex: 1, width: 2, backgroundColor: '#E5E7EB', marginVertical: 4, minHeight: 28 },
  ...
  stepActiveNote: { fontSize: 12, color: '#666', marginTop: 4 },
